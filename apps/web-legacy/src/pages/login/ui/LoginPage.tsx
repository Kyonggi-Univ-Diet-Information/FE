...
export default function LoginPage() {
  return (
    ...
    >
      <div className="rounded-normal border-header-border relative flex h-fit w-[75%] flex-col gap-y-4 border-[1px] bg-white/60 p-10 md:w-120 lg:w-180">
        ...
        <div className="rounded-normal absolute top-0 left-0 z-0 size-full backdrop-blur-sm" />
      </div>
    </div>
  );
}
